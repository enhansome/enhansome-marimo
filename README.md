...
* [Classes using marimo](#classes-using-marimo)
...
*Have a project or resource you'd like to add? Submit a [pull request](https://github.com/marimo-team/awesome-marimo/pulls) ⭐ 220 | 🐛 2 | 📅 2026-08-06!*

### Official Resources

* [GitHub Repo](https://github.com/marimo-team/marimo) ⭐ 22,300 | 🐛 563 | 🌐 Python | 📅 2026-08-12
* [Release Notes](https://github.com/marimo-team/marimo/releases) ⭐ 22,300 | 🐛 563 | 🌐 Python | 📅 2026-08-12
* [marimo learn](https://github.com/marimo-team/learn) ⭐ 347 | 🐛 34 | 🌐 Python | 📅 2026-04-30
* [Awesome marimo](https://github.com/marimo-team/awesome-marimo) ⭐ 220 | 🐛 2 | 📅 2026-08-06
* [VSCode Plugin](https://github.com/marimo-team/vscode-marimo) ⭐ 140 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-28
...
* [marimo-tutorials](https://github.com/Haleshot/marimo-tutorials) ⭐ 58 | 🐛 5 | 🌐 Python | 📅 2025-03-09 - A collection of community-driven tutorials spanning multiple disciplines.

## Get Started

* [Getting Started docs](https://docs.marimo.io/getting_started/index.html) - Getting Started with marimo open source.
* [Gallery](https://marimo.io/gallery) - Community contributed examples.
* [molab](https://molab.marimo.io/notebooks) - Our free hosted notebook.

## Classes using marimo
...
* [Dartbrains](https://dartbrains.org/) - A course at Dartmouth that introduces in vivo neuroimaging in humans using functional magnetic resonance imaging.

## Deployment

* [marimo-jupyter-extension](https://github.com/marimo-team/marimo-jupyter-extension) ⭐ 90 | 🐛 17 | 🌐 Python | 📅 2026-08-12 - Enables the JupyterLab launcher to launch marimo.
* [marimohub](https://github.com/marimo-team/marimohub) ⭐ 47 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13 - Self-host a collaborative marimo workspace.
* [marimo-operator](https://github.com/marimo-team/marimo-operator) ⭐ 25 | 🐛 7 | 🌐 Go | 📅 2026-08-10 - Kubernetes operator for deploying and managing marimo notebooks with persistent storage and resource control.

## Libraries

* [wigglystuff](https://github.com/koaning/wigglystuff) ⭐ 391 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-12 - Creative widgets for explorable explanations.
* [quarto-marimo](https://github.com/dmadisetti/quarto-marimo) ⭐ 192 | 🐛 18 | 🌐 Python | 📅 2026-08-12 - Use marimo and quarto together.
* [mkdocs-marimo](https://github.com/marimo-team/mkdocs-marimo) ⭐ 112 | 🐛 18 | 🌐 Python | 📅 2026-08-01 - A mkdocs plugin for reactive and interactive docs with marimo.
* [mohtml](https://github.com/koaning/mohtml) ⭐ 74 | 🐛 2 | 🌐 Python | 📅 2025-07-03 - DSL for HTML that targets marimo.
* [modraw](https://github.com/koaning/modraw) ⭐ 27 | 🐛 2 | 🌐 Python | 📅 2025-04-11 - Widgets built on top of [tldraw](https://www.tldraw.com/) that allow you to draw.
* [mopaint](https://github.com/koaning/mopaint) ⭐ 25 | 🐛 2 | 🌐 Python | 📅 2025-10-24 - Widget that feels like MSPaint that allows you to draw.
* [expd](https://github.com/marimo-team/expd) ⭐ 23 | 🐛 1 | 🌐 Python | 📅 2026-03-31 - Run computational experiments using marimo notebooks.
* [motest](https://github.com/koaning/motest) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2025-01-04 - Make it easier to use elaborate pytests in marimo notebooks.
* [marimo-scipy-utils](https://github.com/hbmartin/marimo-scipy-utils) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-07-04 - Utility functions for creating interactive marimo components with SciPy distributions.
...
* [marimo agents](https://github.com/marimo-team/marimo/issues/3916) ⭐ 22,300 | 🐛 563 | 🌐 Python | 📅 2026-08-12 - Using agents in marimo.
* [puppy](https://github.com/liquidcarbon/puppy) ⭐ 75 | 🐛 1 | 🌐 Python | 📅 2026-07-27 - A Python project manager, with support for marimo.
* [alhazen](https://github.com/chanzuckerberg/alhazen) ⭐ 42 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-07-17 - AI agents + toolkits for scientific knowledge, with dashboard visualizations in marimo.
* [llmwiki-marimo](https://github.com/Clod/llmwiki-marimo) ⭐ 19 | 🐛 2 | 🌐 Python | 📅 2026-08-10 - A local-first implementation of Karpathy's LLM-Wiki pattern, with marimo apps as the entire UI (ingest PDFs into an interlinked wiki, browse it, chat with cited answers).
* [marimo-pixi-starter-template](https://github.com/Hofer-Julian/marimo-pixi-starter-template) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2025-01-31 - A starter template for marimo notebooks using pixi for dependency and project management.
