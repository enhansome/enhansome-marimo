...
*Have a project or resource you'd like to add? Submit a [pull request](https://github.com/marimo-team/awesome-marimo/pulls) ⭐ 229 | 🐛 3 | 📅 2026-08-06!*

### Official Resources

* [GitHub Repo](https://github.com/marimo-team/marimo) ⭐ 22,682 | 🐛 601 | 🌐 Python | 📅 2026-09-08
* [Release Notes](https://github.com/marimo-team/marimo/releases) ⭐ 22,682 | 🐛 601 | 🌐 Python | 📅 2026-09-08
* [marimo learn](https://github.com/marimo-team/learn) ⭐ 353 | 🐛 34 | 🌐 Python | 📅 2026-04-30
* [Awesome marimo](https://github.com/marimo-team/awesome-marimo) ⭐ 229 | 🐛 3 | 📅 2026-08-06
...
* [marimo-jupyter-extension](https://github.com/marimo-team/marimo-jupyter-extension) ⭐ 92 | 🐛 15 | 🌐 Python | 📅 2026-09-07 - Enables the JupyterLab launcher to launch marimo.
* [marimohub](https://github.com/marimo-team/marimohub) ⭐ 61 | 🐛 11 | 🌐 TypeScript | 📅 2026-09-03 - Self-host a collaborative marimo workspace.
* [marimo-operator](https://github.com/marimo-team/marimo-operator) ⭐ 26 | 🐛 6 | 🌐 Go | 📅 2026-09-07 - Kubernetes operator for deploying and managing marimo notebooks with persistent storage and resource control.

## Libraries

* [wigglystuff](https://github.com/koaning/wigglystuff) ⭐ 412 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-07 - Creative widgets for explorable explanations.
* [quarto-marimo](https://github.com/dmadisetti/quarto-marimo) ⭐ 197 | 🐛 10 | 🌐 Python | 📅 2026-09-07 - Use marimo and quarto together.
...
* [motest](https://github.com/koaning/motest) ⭐ 12 | 🐛 1 | 🌐 Python | 📅 2025-01-04 - Make it easier to use elaborate pytests in marimo notebooks.
* [marimo-scipy-utils](https://github.com/hbmartin/marimo-scipy-utils) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-07-04 - Utility functions for creating interactive marimo components with SciPy distributions.
...
* [marimo agents](https://github.com/marimo-team/marimo/issues/3916) ⭐ 22,682 | 🐛 601 | 🌐 Python | 📅 2026-09-08 - Using agents in marimo.
...
* [llmwiki-marimo](https://github.com/Clod/llmwiki-marimo) ⭐ 21 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - A local-first implementation of Karpathy's LLM-Wiki pattern, with marimo apps as the entire UI (ingest PDFs into an interlinked wiki, browse it, chat with cited answers).
